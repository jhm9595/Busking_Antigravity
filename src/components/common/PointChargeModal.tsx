...
export default function PointChargeModal({ userId, isOpen, onClose, onSuccess }: PointChargeModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 md:p-4 animate-in fade-in duration-300" style={{ backgroundColor: 'var(--color-background)', opacity: 0.9 }}>
                <div className="w-full max-w-xl rounded-[32px] md:rounded-[48px] border shadow-2xl overflow-hidden flex flex-col relative max-h-[92vh]" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
